			   ...
			   <TouchableOpacity onPress={this.props._select.bind(this,data)}>
				<View style={{flexDirection:'row',height:60,alignItems:'center', justifyContent:'space-between',backgroundColor:'#fff',borderBottomWidth:1,borderColor:'#ececec',}}>
				   ...
				   <View style={{flexDirection:'row',marginRight:15, alignSelf:'flex-start',paddingTop:10,}}>
					  <Text style={{marginRight:5,color:'#999',fontSize:12}} allowFontScaling={false}>负责人</Text>
					  <Text style={{color:'#999',fontSize:12}} allowFontScaling={false}>{data.apportion_id}</Text>
				   </View>
			   </View>  
			   </TouchableOpacity>
				)	
