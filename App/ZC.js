      ...
      <View style={{flex:1,flexDirection:'column',}}>
         <View style={{borderColor:'#ccc',borderWidth:1,backgroundColor:'#ddd',height:45,flexDirection:'row',alignItems:'center'}}>
           <TextInput
             ...
             style={{flex:1, color:'#666',fontSize:14,textAlignVertical:'center',textAlign:'center', backgroundColor:'#fff',margin:7,height:30,borderRadius:3,padding:0,paddingLeft:10}}
             placeholder='搜索/资源名称'
             underlineColorAndroid={'transparent'}
             onFocus={this.Focus.bind(this)}
           />
         <Animated.View style={{width:this.state.width,justifyContent:'center',alignItems:'center',overflow:'hidden'}}><Text onPress={this.cancer.bind(this)} allowFontScaling={false} adjustsFontSizeToFit={false} style={{fontSize:16,color:'#4385f4',width:45}}>取消</Text></Animated.View>
         </View>
    		 <ListView
