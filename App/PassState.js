           ...
           return (
              <View style={{alignItems:'center',backgroundColor:'#5d9dd7',flexDirection:'column',position:'absolute',top:0,left:0,height:Dimensions.get('window').height,justifyContent:'space-around'}}>
               ...
               <View style={{width:Dimensions.get('window').width,flexDirection:'row',justifyContent:'space-between',alignItems:'center',paddingLeft:25,paddingRight:25,}}>
                 {this.state.isTouch ? <TouchableHighlight onPress={this.zw.bind(this)} activeOpacity = {0.8} underlayColor="transparent">
                   <View style={{width:100,justifyContent:'center',alignItems:'center'}}>
                      <Text style={{color:'#fff',fontSize:14}} allowFontScaling={false}>指纹解锁</Text>
                   </View>
                 </TouchableHighlight> : <TouchableHighlight  activeOpacity = {0.8} underlayColor="transparent">
                   <View style={{width:100,justifyContent:'center',alignItems:'center'}}>
                      <Text style={{color:'#fff',fontSize:14}} allowFontScaling={false}></Text>
                   </View>
                 </TouchableHighlight>}
