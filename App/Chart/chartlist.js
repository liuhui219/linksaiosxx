...
export default class List extends React.Component {
	...
	getData(){
		fetch('' + this.state.domain + 'app00aee5aa1cc1bf0ecd5d41/dashboard/getBoardListService.do?userId='+data.data.uid+'&category='+this.props.data+'&access_token=32886e81a349f1ef&mtoken=' + data.data.mtoken + '')
