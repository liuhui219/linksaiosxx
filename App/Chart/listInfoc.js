             ...
             <View style={{flex:1,backgroundColor:'#fff',flexDirection:'row',position:'absolute',paddingTop:1,top:0,left:0,zIndex:9999999}}>
                ...
                <View style={{flexDirection:'column',width:180,borderRightWidth:1,borderColor:'#ccc',borderLeftWidth:1,borderColor:'#ccc'}}>
							  ...
							  <ScrollView horizontal={true} onScroll={this.onScroll.bind(this)} scrollEventThrottle={1}>
								  ...
								  <View style={{flexDirection:'column',width:Dimensions.get('window').width,borderRightWidth:1,borderColor:'#ccc'}}>
									 <View style={{flexDirection:'column',flex:1}}>
										<View style={{justifyContent:'center',alignItems:'center',height:40,borderBottomWidth:1,borderColor:'#ccc'}}>
										  <Text allowFontScaling={false} adjustsFontSizeToFit={false}>今日实绩</Text>
										</View>
										...
										<View style={{flexDirection:'row',height:40,justifyContent:'center',alignItems:'center',borderBottomWidth:1,borderColor:'#ccc',}}>
										 <View style={{flex:1,justifyContent:'center',alignItems:'center',borderRightWidth:1,borderColor:'#ccc',height:40}}><Text allowFontScaling={false} adjustsFontSizeToFit={false}  >现有渠道</Text></View>
										 <View style={{flex:1,justifyContent:'center',alignItems:'center',borderRightWidth:1,borderColor:'#ccc',height:40}}><Text allowFontScaling={false} adjustsFontSizeToFit={false}  >新增渠道</Text></View>
										 <View style={{flex:1,justifyContent:'center',alignItems:'center',height:40}}><Text allowFontScaling={false} adjustsFontSizeToFit={false}  >汇总</Text></View>
										</View>
									 </View>
									 <View style={{flex:1,flexDirection:'column',}}>
										{this.state.list.map((lists,i)=>{
											return <View key={i} style={{flexDirection:'row',flex:1,justifyContent:'center',alignItems:'center',borderBottomWidth:1,borderColor:'#ccc',}}>
													  <View style={{flex:1,justifyContent:'center',alignItems:'center',borderRightWidth:1,borderColor:'#ccc',height:40}}><Text allowFontScaling={false} adjustsFontSizeToFit={false} >{lists.day[0]}</Text></View>
													  <View style={{flex:1,justifyContent:'center',alignItems:'center',borderRightWidth:1,borderColor:'#ccc',height:40}}><Text allowFontScaling={false} adjustsFontSizeToFit={false} >{lists.day[1]}</Text></View>
													  <View style={{flex:1,justifyContent:'center',alignItems:'center',height:40}}><Text allowFontScaling={false} adjustsFontSizeToFit={false} >{lists.day[2]}</Text></View>
								  ...
								  <View style={{flexDirection:'column',width:Dimensions.get('window').width,borderRightWidth:1,borderColor:'#ccc'}}>
									 ...
									 <View style={{flex:1,flexDirection:'column',}}>
										{this.state.list.map((lists,i)=>{
											return <View key={i} style={{flexDirection:'row',flex:1,justifyContent:'center',alignItems:'center',borderBottomWidth:1,borderColor:'#ccc',}}>
													  <View style={{flex:1,justifyContent:'center',alignItems:'center',borderRightWidth:1,borderColor:'#ccc',height:40}}><Text allowFontScaling={false} adjustsFontSizeToFit={false} >{lists.month[0]}</Text></View>
													  <View style={{flex:1,justifyContent:'center',alignItems:'center',borderRightWidth:1,borderColor:'#ccc',height:40}}><Text allowFontScaling={false} adjustsFontSizeToFit={false} >{lists.month[1]}</Text></View>
													  <View style={{flex:1,justifyContent:'center',alignItems:'center',height:40}}><Text allowFontScaling={false} adjustsFontSizeToFit={false} >{lists.month[2]}</Text></View>
													</View>
										})}
