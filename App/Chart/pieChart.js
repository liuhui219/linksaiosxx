    ...
    return (
      ...
      <View style={{flex: 1,backgroundColor:'#fff'}}>
       ...
       <View style={styles.card}>
		...
		<View style={{flex:1,flexDirection:'row',marginTop:35,marginBottom:15}}>
		  <View style={{flexDirection:'column',borderColor:'#ccc',borderLeftWidth:1,}}>
		      <View style={{flex:1,borderBottomWidth:1,borderTopWidth:1,borderColor:'#ccc',paddingBottom:10,paddingTop:10,paddingLeft:10,paddingRight:10,justifyContent:'center',alignItems: 'center',height:35}}><Text allowFontScaling={false} adjustsFontSizeToFit={false}  style={{fontSize:12}}></Text></View>
			  {this.state.ArX.map((data,i)=>{
				  return <View key={i} style={{flex:1,borderBottomWidth:1,borderColor:'#ccc',height:35}}><Text allowFontScaling={false} adjustsFontSizeToFit={false}  style={{flex:1,borderBottomWidth:1,borderColor:'#ccc',paddingBottom:10,paddingTop:10,paddingLeft:10,paddingRight:10,justifyContent:'center',alignItems: 'center',fontSize:12,}}>{data}</Text></View>
			  })}
		  </View>
		  <View style={{flex:1,flexDirection:'row',}}>
			  {this.state.arrX.map((data,x)=>{
				  return <View key={x} style={{flex:1,flexDirection:'column',}}>
				          <View style={{flex:1,borderBottomWidth:1,borderTopWidth:1,borderLeftWidth:1,borderColor:'#ccc',paddingBottom:10,paddingTop:10,justifyContent:'center',alignItems: 'center',height:35}}><Text allowFontScaling={false} adjustsFontSizeToFit={false} style={{fontSize:12}}>{this.state.values[x]}</Text></View>
						  {data.values.map((ds,y)=>{
						    return <View style={{flex:1,borderBottomWidth:1,borderColor:'#ccc',borderLeftWidth:1,paddingBottom:10,paddingTop:10,justifyContent:'center',alignItems: 'center',height:35}}><Text key={y} allowFontScaling={false} adjustsFontSizeToFit={false} style={{fontSize:12}}>{ds}</Text></View>
						  })}
				  </View>
			  })}
		  </View>
